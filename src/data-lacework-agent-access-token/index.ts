// https://registry.terraform.io/providers/lacework/lacework/1.15.0/docs/data-sources/agent_access_token
...
export interface DataLaceworkAgentAccessTokenConfig extends cdktf.TerraformMetaArguments {
  /**
...
*/
export class DataLaceworkAgentAccessToken extends cdktf.TerraformDataSource {
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/lacework/lacework/1.15.0/docs/data-sources/agent_access_token lacework_agent_access_token} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataLaceworkAgentAccessTokenConfig
  */
  public constructor(scope: Construct, id: string, config: DataLaceworkAgentAccessTokenConfig) {
    super(scope, id, {
