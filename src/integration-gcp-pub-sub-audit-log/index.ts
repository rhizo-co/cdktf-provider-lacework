// https://registry.terraform.io/providers/lacework/lacework/1.15.0/docs/resources/integration_gcp_pub_sub_audit_log
...
export interface IntegrationGcpPubSubAuditLogConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  */
  readonly credentials: IntegrationGcpPubSubAuditLogCredentials;
}
...
export function integrationGcpPubSubAuditLogCredentialsToTerraform(struct?: IntegrationGcpPubSubAuditLogCredentialsOutputReference | IntegrationGcpPubSubAuditLogCredentials): any {
...
export class IntegrationGcpPubSubAuditLogCredentialsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): IntegrationGcpPubSubAuditLogCredentials | undefined {
  ...
  public set internalValue(value: IntegrationGcpPubSubAuditLogCredentials | undefined) {
    if (value === undefined) {
...
*/
export class IntegrationGcpPubSubAuditLog extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "lacework_integration_gcp_pub_sub_audit_log";
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/lacework/lacework/1.15.0/docs/resources/integration_gcp_pub_sub_audit_log lacework_integration_gcp_pub_sub_audit_log} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options IntegrationGcpPubSubAuditLogConfig
  */
  public constructor(scope: Construct, id: string, config: IntegrationGcpPubSubAuditLogConfig) {
    super(scope, id, {
  ...
  private _credentials = new IntegrationGcpPubSubAuditLogCredentialsOutputReference(this, "credentials");
  public get credentials() {
    return this._credentials;
  }
  public putCredentials(value: IntegrationGcpPubSubAuditLogCredentials) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      credentials: integrationGcpPubSubAuditLogCredentialsToTerraform(this._credentials.internalValue),
    };
  }
}
