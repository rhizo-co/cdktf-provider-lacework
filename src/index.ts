...
export * as resourceGroupAccount from './resource-group-account';
export * as resourceGroupAws from './resource-group-aws';
export * as resourceGroupAzure from './resource-group-azure';
export * as resourceGroupContainer from './resource-group-container';
export * as resourceGroupGcp from './resource-group-gcp';
export * as resourceGroupMachine from './resource-group-machine';
