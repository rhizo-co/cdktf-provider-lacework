// https://registry.terraform.io/providers/lacework/lacework/1.15.0/docs/resources/alert_channel_microsoft_teams
...
export interface AlertChannelMicrosoftTeamsConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class AlertChannelMicrosoftTeams extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "lacework_alert_channel_microsoft_teams";
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/lacework/lacework/1.15.0/docs/resources/alert_channel_microsoft_teams lacework_alert_channel_microsoft_teams} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options AlertChannelMicrosoftTeamsConfig
  */
  public constructor(scope: Construct, id: string, config: AlertChannelMicrosoftTeamsConfig) {
    super(scope, id, {
