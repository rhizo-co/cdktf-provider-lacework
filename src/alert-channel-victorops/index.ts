// https://registry.terraform.io/providers/lacework/lacework/1.15.0/docs/resources/alert_channel_victorops
...
export interface AlertChannelVictoropsConfig extends cdktf.TerraformMetaArguments {
  /**
...
*/
export class AlertChannelVictorops extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "lacework_alert_channel_victorops";
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/lacework/lacework/1.15.0/docs/resources/alert_channel_victorops lacework_alert_channel_victorops} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options AlertChannelVictoropsConfig
  */
  public constructor(scope: Construct, id: string, config: AlertChannelVictoropsConfig) {
    super(scope, id, {
      terraformResourceType: 'lacework_alert_channel_victorops',
