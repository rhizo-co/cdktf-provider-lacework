// https://registry.terraform.io/providers/lacework/lacework/1.15.0/docs/resources/alert_channel_aws_cloudwatch
...
export interface AlertChannelAwsCloudwatchConfig extends cdktf.TerraformMetaArguments {
  /**
...
*/
export class AlertChannelAwsCloudwatch extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "lacework_alert_channel_aws_cloudwatch";
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/lacework/lacework/1.15.0/docs/resources/alert_channel_aws_cloudwatch lacework_alert_channel_aws_cloudwatch} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options AlertChannelAwsCloudwatchConfig
  */
  public constructor(scope: Construct, id: string, config: AlertChannelAwsCloudwatchConfig) {
    super(scope, id, {
      terraformResourceType: 'lacework_alert_channel_aws_cloudwatch',
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      event_bus_arn: cdktf.stringToTerraform(this._eventBusArn),
