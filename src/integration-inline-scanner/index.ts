// https://registry.terraform.io/providers/lacework/lacework/1.15.0/docs/resources/integration_inline_scanner
...
export interface IntegrationInlineScannerConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function integrationInlineScannerIdentifierTagToTerraform(struct?: IntegrationInlineScannerIdentifierTag | cdktf.IResolvable): any {
...
export class IntegrationInlineScannerIdentifierTagOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): IntegrationInlineScannerIdentifierTag | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: IntegrationInlineScannerIdentifierTag | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class IntegrationInlineScannerIdentifierTagList extends cdktf.ComplexList {
  public internalValue? : IntegrationInlineScannerIdentifierTag[] | cdktf.IResolvable
  ...
  */
  public get(index: number): IntegrationInlineScannerIdentifierTagOutputReference {
    return new IntegrationInlineScannerIdentifierTagOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class IntegrationInlineScanner extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "lacework_integration_inline_scanner";
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/lacework/lacework/1.15.0/docs/resources/integration_inline_scanner lacework_integration_inline_scanner} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options IntegrationInlineScannerConfig
  */
  public constructor(scope: Construct, id: string, config: IntegrationInlineScannerConfig) {
    super(scope, id, {
    ...
    this._id = config.id;
    this._limitNumScan = config.limitNumScan;
    this._name = config.name;
    this._identifierTag.internalValue = config.identifierTag;
  }
  ...
  // limit_num_scan - computed: false, optional: true, required: false
  private _limitNumScan?: number; 
  public get limitNumScan() {
    return this.getNumberAttribute('limit_num_scan');
  }
  public set limitNumScan(value: number) {
    this._limitNumScan = value;
  }
  public resetLimitNumScan() {
    this._limitNumScan = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get limitNumScanInput() {
    return this._limitNumScan;
  }
  ...
  // identifier_tag - computed: false, optional: true, required: false
  private _identifierTag = new IntegrationInlineScannerIdentifierTagList(this, "identifier_tag", true);
  public get identifierTag() {
    return this._identifierTag;
  }
  public putIdentifierTag(value: IntegrationInlineScannerIdentifierTag[] | cdktf.IResolvable) {
    this._identifierTag.internalValue = value;
  }
  public resetIdentifierTag() {
    this._identifierTag.internalValue = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get identifierTagInput() {
    return this._identifierTag.internalValue;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      limit_num_scan: cdktf.numberToTerraform(this._limitNumScan),
      name: cdktf.stringToTerraform(this._name),
      identifier_tag: cdktf.listMapper(integrationInlineScannerIdentifierTagToTerraform, true)(this._identifierTag.internalValue),
    };
  }
}
