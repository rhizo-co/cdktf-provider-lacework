// https://registry.terraform.io/providers/lacework/lacework/1.15.0/docs/resources/alert_channel_cisco_webex
...
export interface AlertChannelCiscoWebexConfig extends cdktf.TerraformMetaArguments {
  /**
...
*/
export class AlertChannelCiscoWebex extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "lacework_alert_channel_cisco_webex";
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/lacework/lacework/1.15.0/docs/resources/alert_channel_cisco_webex lacework_alert_channel_cisco_webex} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options AlertChannelCiscoWebexConfig
  */
  public constructor(scope: Construct, id: string, config: AlertChannelCiscoWebexConfig) {
    super(scope, id, {
