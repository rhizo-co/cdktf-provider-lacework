// https://registry.terraform.io/providers/lacework/lacework/1.15.0/docs/resources/integration_gar
...
export function integrationGarCredentialsToTerraform(struct?: IntegrationGarCredentialsOutputReference | IntegrationGarCredentials): any {
...
export class IntegrationGarCredentialsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): IntegrationGarCredentials | undefined {
  ...
  public set internalValue(value: IntegrationGarCredentials | undefined) {
    if (value === undefined) {
...
export function integrationGarLimitByLabelToTerraform(struct?: IntegrationGarLimitByLabel | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class IntegrationGarLimitByLabelOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): IntegrationGarLimitByLabel | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: IntegrationGarLimitByLabel | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class IntegrationGarLimitByLabelList extends cdktf.ComplexList {
  public internalValue? : IntegrationGarLimitByLabel[] | cdktf.IResolvable
  ...
  */
  public get(index: number): IntegrationGarLimitByLabelOutputReference {
    return new IntegrationGarLimitByLabelOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class IntegrationGar extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "lacework_integration_gar";
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/lacework/lacework/1.15.0/docs/resources/integration_gar lacework_integration_gar} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options IntegrationGarConfig
  */
  public constructor(scope: Construct, id: string, config: IntegrationGarConfig) {
    super(scope, id, {
  ...
  private _credentials = new IntegrationGarCredentialsOutputReference(this, "credentials");
  public get credentials() {
    return this._credentials;
  }
  public putCredentials(value: IntegrationGarCredentials) {
  ...
  private _limitByLabel = new IntegrationGarLimitByLabelList(this, "limit_by_label", true);
  public get limitByLabel() {
    return this._limitByLabel;
  }
  public putLimitByLabel(value: IntegrationGarLimitByLabel[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      credentials: integrationGarCredentialsToTerraform(this._credentials.internalValue),
      limit_by_label: cdktf.listMapper(integrationGarLimitByLabelToTerraform, true)(this._limitByLabel.internalValue),
    };
  }
}
